...
const Story = () => (
  <div className="columns storyContainer">
      ...
      <div className="column">
        <p className="infoText is-size-7-mobile">&#x2192; In December 2017, Michael “Zaki” Smith got a letter
        ...
        <p className="infoText is-size-7-mobile">&#x2192; After a routine background check, Zaki’s position was
        ...
        <p className="infoText is-size-7-mobile">&#x2192; Collateral consequences are a legal term for the lifetime
        of perpetual punishment an individual continues to receive
        well after they have served their time—or even have just
        been arrested.</p>

        <p className="infoText is-size-7-mobile">&#x2192; The moment an individual pleads guilty to a crime,
        ...
        <p className="infoText is-size-7-mobile">&#x2192; Zaki launched The Fair Chance Project to raise
        ...
        <p className="infoText is-size-7-mobile">&#x2192; The Fair Chance Project hosts the <span className="is-italic">Feast for Fair
        Chances</span>, community dinners where we promote both
