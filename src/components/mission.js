...
const Mission = () => (
  <div className="columns storyContainer">
      ...
      <div className="column">
        <p className="infoText">&#x2192; Today, when a person is convicted of a crime, a system
        ...
        <p className="infoText">&#x2192; 47,000 laws today restrict access to employment,
        ...
        <p className="infoText">&#x2192; This system keeps people from rejoining society,
