    ...
    <div className="columns">
      <div className="column footer-section">
        ...
        <p className="footer-text">
          Come break bread with us. We host community dinners called{" "}
          <span className="is-italic">A Feast for Fair Chances</span> to promote
          awareness of collateral consequences and open discussion into what it
          means to have a fair chance.
        </p>
      ...
      <div className="column footer-section">
        ...
        <p className="footer-text">
          Bring this issue into the light with us. From those who work in the
          justice system, to those convicted of crimes, to the general
          public—few understand the true impact that these laws have.
        </p>
        <FacebookShareButton
      ...
      <div className="column footer-section">
        ...
        <p className="footer-text">
          Work alongside us. We seek to reform the system of 47,000 laws that
